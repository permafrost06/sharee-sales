        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    ...
                    @endif
                    <form class="form-horizontal" action="{{ route('sales.update') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="box-body">
                            <div class="row">
                                @if ($errors->any())
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="date" value="{{ $sale->date }}" class="form-control" id="datepicker" placeholder="date">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="memo_number" value="{{ $sale->memo_number }}" class="form-control" id="name" placeholder="memo number">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" min="0" value="{{ $sale->goods_of_issues }}"  step="0.01" name="goods_of_issues" class="form-control" id="" >
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" min="0" value="{{ $sale->lv }}" step="0.01" name="lv" class="form-control" id="" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" min="0" value="{{ $sale->received_money }}" step="0.01" name="received_money" class="form-control" id="" >
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" min="0" value="{{ $sale->balance_due }}" step="0.01" name="balance_due" class="form-control" id="" >
                                            </div>
                                        </div>
                                        <div class="form-group">

...
{{--          <span class="label label-primary pull-right">4</span>--}}
                ...
                <ul class="treeview-menu">
                    <li><a href="{{ route('customers.create') }}"><i class="fa fa-plus"></i> <span>Add Customer</span></a></li>
                    <li><a href="{{ route('customers.index') }}"><i class="fa fa-users"></i> <span>Customer list</span></a></li>
                </ul>
            </li>
...
{{--          <span class="label label-primary pull-right">4</span>--}}</span>
                ...
                <ul class="treeview-menu">
                    <li><a href="{{ route('vendor.create') }}"><i class="fa fa-plus"></i> <span>Add Vendor</span></a></li>
                    <li><a href="{{ route('vendor.index') }}"><i class="fa fa-users"></i> <span>Vendor list</span></a></li>
                </ul>
            </li>
                <li>

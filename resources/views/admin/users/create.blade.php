                                    ...
                                    <div class="col-md-6">
                                                ...
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" name="customers_name" class="form-control" id="inputPassword3" placeholder="customer name">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="number" min="0" name="customers_limit" class="form-control" id="" >
                                                        </div>
                                                    </div>
                                                    <div class="form-group">

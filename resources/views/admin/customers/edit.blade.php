                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="customers_id" value="{{$customer->customers_id}}" class="form-control" id="ID" placeholder="Enter customers id">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" min="0" name="limit" value="{{$customer->limit}}" class="form-control" id="" >
                                            </div>
                                        </div>
                                        <div class="form-group">

        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    ...
                    @endif
                    <form class="form-horizontal" action="{{ route('vendor.update') }}" method="post"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="name" value="{{ $vendor->name }}"
                                                    class="form-control" id="name" placeholder="vendor name">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" min="0" name="limit"
                                                    value="{{ $vendor->limit }}" class="form-control" id="">
                                            </div>
                                        </div>

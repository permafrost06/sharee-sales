        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    ...
                    @endif
                    <form class="form-horizontal" action="{{ route('vendor.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="box-body">
                            <div class="row">
                                @if ($errors->any())
                                    ...
                                    <div class="col-md-6">
                                                ...
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" name="id" class="form-control" id="ID" placeholder="Enter vendor id">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" name="name" class="form-control" id="name" placeholder="vendor name">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">

...
@section('page')
    ...
    <x-cards.card class="max-w-4xl">
        <div class="flex items-center py-2 border-b px-6">
            <h3 class="flex-grow text-dark font-medium">{{ $purchase ? 'Update Purchase' : 'Add New Purchase' }}</h3>
            <a href="{{ route('purchase.index') }}" class="inline-flex items-center px-3 py-1.5 bg-blue-500 focus:ring ring-blue-600 hover:bg-blue-600 text-white uppercase font-semibold text-xs rounded">
                View All
            </a>
        </div>

...
@section('head')
    <script>
        const PURCHASES_API_LINK = "{{ route('purchase.api', ['id' => $vendor?->id]) }}";
        const PURCHASE_EDIT_LINK = "{{ route('purchase.edit', ['id' => '::ID::']) }}";
        const PURCHASE_DELETE_LINK = "{{ route('purchase.delete', ['id' => '::ID::']) }}";
        const CSRF = "{{ csrf_token() }}";
    </script>
    @vite(['resources/js/pages/admin/purchases.js'])
@endsection

        ...
        <div class="relative w-full max-w-md max-h-full">
            <div class="relative bg-skin-foreground rounded-lg shadow">
                ...
                >
                    ...
                    <p class="mb-5 text-lg font-normal text-gray-400">
                        <slot></slot>
                    </p>
                    <div class="flex items-center justify-center">
                        <button
                            ...
                            :disabled="loading"
                            type="submit"
                            class="text-skin-inverted bg-skin-danger bg-opacity-90 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2"
                            :class="{
                                'hover:bg-opacity-100 focus:ring-4 focus:outline-none focus:ring-skin-danger':
                                    !loading,
                            }"
                        >
                            <div v-if="loading" role="status">
                                <svg
                                    aria-hidden="true"
                                    class="w-4 h-4 mr-2 text-gray-200 animate-spin fill-blue-600"
                                    viewBox="0 0 100 101"
                                    fill="none"
                                    xmlns="http://www.w3.org/2000/svg"
                                >

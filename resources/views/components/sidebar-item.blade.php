<li class="my-2">
    <a href="{{ $link }}" @class([
        'flex items-center p-2 collapsed:md:max-w-min hover:bg-accent hover:bg-opacity-20 rounded-md',
        'bg-accent text-accent bg-opacity-10' => Route::currentRouteName() == $route,
    ])>
        @isset($svg)

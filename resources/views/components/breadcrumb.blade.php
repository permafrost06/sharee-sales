<nav class="flex" aria-label="Breadcrumb">
    <ol class="inline-flex items-center space-x-1 md:space-x-3">
        <li class="inline-flex items-center">
            <a href="{{ $home['link'] }}" class="inline-flex items-center font-medium hover:text-accent">
        ...
        @foreach ($items as $item)
            <li>
                <div class="flex items-center">
                    <svg aria-hidden="true" class="w-6 h-6 text-textSecondary" fill="currentColor" viewBox="0 0 20 20"
        ...
        <li aria-current="page">
            <div class="flex items-center">
                ...
                <span class="ml-1 font-medium text-textSecondary md:ml-2">{{ $active }}</span>
            </div>
        </li>
        @endif
    </ol>
